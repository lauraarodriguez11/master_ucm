    ...
    for i in range(n_components):
        for j in range(i + 1, n_components):  # Evitar pares duplicados
            ...
            for k, var_name in enumerate(correlaciones_datos_con_cp.index):
                ...
                color = cmap(sum_cos2.iloc[k])  # Usar iloc para acceder a la posición
            ...
            sm.set_array(sum_cos2)  # Agregar datos al mapeable
            plt.colorbar(sm, ax=ax, orientation='vertical', label='cos^2')  # Asociar el colorbar al eje ax
