...
from FuncionesMineria_Corrected import (graficoVcramer, impVariablesLog, pseudoR2, glm, summary_glm, 
...
eliminar = ['xsqft_living', 'xsqft_lot', 'xsqft_above', 'xyr_built',
            'xlat', 'xlong', 'yr_built']
...
var_cont1 = ['sqft_living', 'sqft_lot', 'sqft_above', 'lat', 'long', 'prop_missings']
var_categ1 = ['bedrooms', 'bathrooms', 'floors', 'waterfront', 'view', 'condition', 'basement', 'prueba']
...
var_cont2 = ['CloruroSodico', 'Sulfatos', 'pH']
